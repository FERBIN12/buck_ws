...
#include "pointcloud/msg/detail/point_cloud__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const pointcloud::msg::PointCloud *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pointcloud::msg::PointCloud *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_pointcloud
const rosidl_message_type_support_t *
get_message_type_support_handle<pointcloud::msg::PointCloud>()
{
  return &pointcloud::msg::typesupport_fastrtps_cpp::_PointCloud__handle;
}
